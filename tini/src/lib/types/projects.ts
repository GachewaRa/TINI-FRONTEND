...
// src/lib/types/projects.ts - Add these types to your existing file
...
export interface ProjectFolder extends ProjectFolderBase {
  ...
  created_at: Date;
  updated_at: Date;
  projects?: Project[]; // Optional, populated when needed
}
...
export interface ProjectResponse extends Omit<Project, 'created_at' | 'updated_at'> {
  created_at: string;
  updated_at: string;
}
